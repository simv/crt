...
describe("popover placement (F-65)", () => {
  ...
  it("goes below, then above, when neither side fits a wide element", () => {
  ...
  it("clamps the cross axis so the popover stays inside the viewport", () => {
  ...
  it("clamps both axes when nothing fits (element fills the viewport)", () => {
  ...
  it("handles a pin (1×1 anchor) like any other marker", () => {
