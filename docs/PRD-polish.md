...
- [ ] CI green on `main`; `v0.6.0` tagged, published and promoted; the GitHub Release names M19–M23; the npm page shows the lockup (M24). — pending on CRT-0028's tag and Simon's promotion; the evidence (the PR's run on `main`, the tag's commit, the `release` run id, the Release notes, `npm view claude-review-tool version`) goes here in CRT-0028's close-out.
